...
import com.example.phishing_detecting.api.AnalysisApi;
import com.example.phishing_detecting.api.AnalysisRequest;
import com.example.phishing_detecting.api.AnalysisResponse;
import com.example.phishing_detecting.api.ApiClient;
...
public class SttAnalysisActivity extends AppCompatActivity {
    ...
    private static final String SAMPLE1 =
            "저희 수사과에서 금융사기주범 아무개를 검거했는데 압수수색 당시 현장에서 " +
